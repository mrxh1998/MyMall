...
public class IndexController {
    ...
    public String indexPage(HttpServletRequest request) {
        ...
        List<NewBeeMallIndexConfigGoodsVO> hotGoodses = newBeeMallIndexConfigService.getHotGoods();
        List<NewBeeMallIndexConfigGoodsVO> newGoodses = newBeeMallIndexConfigService.getNewGoods(Constants.INDEX_GOODS_NEW_NUMBER);
